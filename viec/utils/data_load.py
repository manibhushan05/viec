...
def load_country_data():
    country = [
        ...
        {"name": "Chad", "dial_code": "+235", "code": "TD"}, {"name": "Chile", "dial_code": "+56", "code": "CL"},
    ...
    for data in country:
        if not Country.objects.filter(code=data['code']).exists():
            Country.objects.create(name=data['name'], code=data['code'], dial_code=data['dial_code'])
